...
parser.add_argument("site", type=str, help='Название типа сайта для парсинга. Возможные значения: korting, housedorf, dedietrich, falmec, vzug, asco, kuppersbush, konigin, evelux, franke, franke-dealer, elica, smeg, shaublorenz, shaublorenz_shop, graude, history, blanco, fashun, geizer. ')
